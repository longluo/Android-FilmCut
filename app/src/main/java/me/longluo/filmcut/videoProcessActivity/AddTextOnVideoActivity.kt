...
import me.longluo.videooperations.Common.getFileFromAssets
import me.longluo.videooperations.FFmpegCallBack
import me.longluo.videooperations.LogMessage
import java.util.concurrent.CompletableFuture.runAsync

class AddTextOnVideoActivity :
    BaseActivity(R.layout.activity_add_text_on_video, R.string.add_text_on_video) {
            ...
            R.id.btnAdd -> {
                when {
                    ...
                    TextUtils.isEmpty(edtText.text.toString()) -> {
                        Toast.makeText(
                            this,
                            getString(R.string.please_add_text_validation),
                            Toast.LENGTH_SHORT
                        ).show()
                    }
