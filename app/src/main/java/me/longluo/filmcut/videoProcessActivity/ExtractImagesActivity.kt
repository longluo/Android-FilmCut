...
import me.longluo.videooperations.Statistics
import java.io.File

class ExtractImagesActivity :
    BaseActivity(R.layout.activity_extract_images, R.string.extract_frame_from_video) {
    ...
    private fun extractProcess() {
        ...
        val query = ffmpegQueryExtension.extractImages(
